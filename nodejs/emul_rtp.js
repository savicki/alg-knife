...
var interval    = ( argsCount >= 6 ) ? parseInt( process.argv[argInd + 5] ) : null;
var rate        = ( argsCount >= 7 ) ? parseInt( process.argv[argInd + 6] ) : null;
var send_msg    = ( argsCount >= 8 ) ? process.argv[argInd + 7] : null;


mycmn.emitRTP( trans_proto, local_ip, local_port, dst_ip, dst_port, send_msg, interval /* interval, sec. */, rate, null /* completeFn */ );